...
- **Nov 2020** - Content configuration version 2 released. Added a new more configurable way of adding data to the resume. Add as many content sections as you like in what ever order you want. Currently just _text_ and _list_ but future categories coming soon.
...
**list** is a the standard layout that is used for things like _Education_ and _Experience_.
